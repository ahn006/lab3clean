...
class kernel{
    ...
    public static enum opcodes {
		ADDU, SUBU, SLLV, ROTL, SRAV, SRLV, AND, ROTR, XOR, OR, NOR, SLT, SLTU, MOV, LW, LBU, SW, SB, JALR,
	...
	public static void initialization() throws IOException {
		...
		opcodeTable.put("ROTL",  "01011");
		opcodeTable.put("ROTR", "10100");
		opcodeTable.put("XOR",	"01101");
